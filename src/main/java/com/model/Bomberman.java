...
public class Bomberman {
    ...
    public Bomberman() {
        ...
        try {
            up = ImageIO.read(this.getClass().getResource("/images/bomberman/up.gif"));
            down = ImageIO.read(this.getClass().getResource("/images/bomberman/down.gif"));
            right = ImageIO.read(this.getClass().getResource("/images/bomberman/right.gif"));
            left = ImageIO.read(this.getClass().getResource("/images/bomberman/left.gif"));
            leftW = ImageIO.read(this.getClass().getResource("/images/bomberman/b_left.gif"));
            rightW = ImageIO.read(this.getClass().getResource("/images/bomberman/b_right.gif"));
            upW = ImageIO.read(this.getClass().getResource("/images/bomberman/b_up.gif"));
            downW = ImageIO.read(this.getClass().getResource("/images/bomberman/b_down.gif"));
        } catch (IOException e) {
            e.printStackTrace();
        }
